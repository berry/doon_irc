...
Elm.SelectionList.make = function (_elm) {
   ...
   var previous = function (list) {
      ...
      if (_p0.ctor === "[]") {
            ...
            {selected: _p0._0
            ,previous: _p0._1
            ,next: A2($List._op["::"],list.selected,list.next)});
         }
   };
   var next = function (list) {
      ...
      if (_p1.ctor === "[]") {
            ...
            return _U.update(list,
            {selected: _p1._0
            ,previous: A2($List._op["::"],list.selected,list.previous)
            ,next: _p1._1});
         }
   };
   var $goto = F2(function (n,list) {
      $goto: while (true) {
         ...
         if (_U.eq(curIndex,n)) return list; else if (_U.cmp(curIndex,
            n) < 0 && _U.cmp($List.length(list.next),0) > 0) {
   ...
   var map2 = F3(function (f,listA,listB) {
      ...
      {previous: A3($List.map2,f,listA.previous,listB.previous)
      ,selected: A2(f,listA.selected,listB.selected)
      ,next: A3($List.map2,f,listA.next,listB.next)});
   });
   var andMap = map2(F2(function (x,y) {    return x(y);}));
   var updateN = F3(function (n,f,list) {
      return A2(indexedMap,
      F2(function (index,value) {
         return _U.eq(index,n) ? f(value) : value;
      }),
      list);
   });
   var updateSelected = F2(function (f,list) {
      return _U.update(list,{selected: f(list.selected)});
   });
   var map = F2(function (f,list) {
      return _U.update(list,
      {previous: A2($List.map,f,list.previous)
      ,selected: f(list.selected)
      ,next: A2($List.map,f,list.next)});
   });
   ...
   var toList = function (list) {
      ...
      $List.reverse(list.previous),
      A2($Basics._op["++"],_U.list([list.selected]),list.next));
   };
   var SelectionList = F3(function (a,b,c) {
      return {previous: a,selected: b,next: c};
   });
   var fromList = F2(function (selected,next) {
      return A3(SelectionList,_U.list([]),selected,next);
   });
...
Elm.InnoCheckModel.make = function (_elm) {
   ...
   if (_elm.InnoCheckModel.values)
   return _elm.InnoCheckModel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var answerColorList = $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                 ,_0: "Yes"
                                                 ,_1: answerColorGreen}
   ...
   var Person = F4(function (a,b,c,d) {
      return {email: a,firstname: b,lastname: c,companyname: d};
   });
   var Recommendation = F4(function (a,b,c,d) {
   ...
   var Yes = {ctor: "Yes"};
   var questionAnswers0 = $Dict.fromList(_U.list([{ctor: "_Tuple2"
                                                  ,_0: 1
                                                  ,_1: Yes}
   ...
   var answerTextList = _U.list([{ctor: "_Tuple2",_0: Yes,_1: "Ja"}
                                ,{ctor: "_Tuple2",_0: Partly,_1: "Deels"}
                                ,{ctor: "_Tuple2",_0: No,_1: "Nee"}]);
   var answerScoreList = _U.list([{ctor: "_Tuple2",_0: Yes,_1: 3}
                                 ,{ctor: "_Tuple2",_0: Partly,_1: 1}
                                 ,{ctor: "_Tuple2",_0: No,_1: 0}]);
   ...
   var aspectList = _U.list([{ctor: "_Tuple2"
                             ,_0: Leadership
                             ,_1: "Leiderschap"}
                            ...
                            ,{ctor: "_Tuple2"
                             ,_0: MeasureAndMonitor
                             ,_1: "Meten en monitoren"}
...
Elm.InnoCheckUtil.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var getValue = F2(function (dict,key) {
      return A2($Dict.get,$Basics.toString(key),dict);
   });
   ...
   var getAspectText = function (aspect) {
      ...
      "",
      A2(getValue,unionToDict($InnoCheckModel.aspectList),aspect));
   };
   var getAnswerText = function (answer) {
      return A2($Maybe.withDefault,
      "",
      A2(getValue,
   ...
   var allQuestionsAnswered = F2(function (questions,qanswers) {
   ...
   var meanScoreColor = F2(function (aqa,score) {
      return _U.cmp(score,0) > -1 && _U.cmp(score,
   ...
   kscores) {
      var getAnswerScore = function (q) {
         return {ctor: "_Tuple2"
                ,_0: q.aspect
                ,_1: A2($Maybe.withDefault,0,A2($Dict.get,q.key,kscores))};
      };
   ...
   acolors) {
      var getAnswerColor = function (q) {
         return {ctor: "_Tuple2"
                ...
                $InnoCheckModel.answerColorEmpty,
   ...
   var listAnswerColor = function (qas) {
      var getAnswerColor = F2(function (key,answer) {
         ...
         A2($Dict.get,
         $Basics.toString(answer),
         $InnoCheckModel.answerColorList));
      });
      return A2($Dict.map,getAnswerColor,qas);
   };
   var aspectQuestions = F2(function (questions,aspect) {
      return A2($List.filter,
      function (q) {
         return _U.eq(q.aspect,aspect);
      },
      questions);
   });
   var meanScorePerAspect = function (model) {
      ...
      var answerScores = function (aspect) {
         ...
         A2(aspectQuestions,model.questions,aspect),
   ...
   var aspectForTip = function (model) {
      ...
      function (_p2) {
         var _p3 = _p2;
         var _p4 = _p3._1;
         return _U.cmp(_p4,30) > 0 && _U.cmp(_p4,60) < 0;
      },
      aspectScores);
      ...
      function (_p5) {
         var _p6 = _p5;
         var _p7 = _p6._1;
         return _U.cmp(_p7,0) > -1 && _U.cmp(_p7,30) < 1;
      },
      aspectScores);
...
Elm.InnoCheckBackend.make = function (_elm) {
   ...
   if (_elm.InnoCheckBackend.values)
   ...
   var encodeQuestionAnwsers = function (questionAnswers) {
      var encodeQuestionAnswer = function (_p0) {
         ...
         return {ctor: "_Tuple2"
                ,_0: $Basics.toString(_p1._0)
                ,_1: $Json$Encode.string($InnoCheckUtil.getAnswerText(_p1._1))};
      };
      return $Json$Encode.object(A2($List.map,
      encodeQuestionAnswer,
      $Dict.toList(questionAnswers)));
   };
   var encodeQuestions = function (questions) {
      var encodeQuestion = function (q) {
         return $Json$Encode.object(_U.list([{ctor: "_Tuple2"
                                             ,_0: "key"
                                             ,_1: $Json$Encode.$int(q.key)}
                                            ,{ctor: "_Tuple2"
                                             ,_0: "aspect"
                                             ,_1: $Json$Encode.string($InnoCheckUtil.getAspectText(q.aspect))}
                                            ,{ctor: "_Tuple2"
                                             ,_0: "text"
                                             ,_1: $Json$Encode.string(q.text)}]));
      };
...
Elm.InnoCheckViewUtil.make = function (_elm) {
   ...
   if (_elm.InnoCheckViewUtil.values)
   return _elm.InnoCheckViewUtil.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var clickable = $Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                   ,_0: "cursor"
                                                   ,_1: "pointer"}]));
   return _elm.InnoCheckViewUtil.values = {_op: _op
                                          ,clickable: clickable};
};
...
Elm.InnoCheckViewSvg.make = function (_elm) {
   ...
   if (_elm.InnoCheckViewSvg.values)
   ...
   _p2) {
      ...
      meanOfAnswers);
      return A2($Svg.svg,
      _U.list([$InnoCheckViewUtil.clickable
   ...
   return _elm.InnoCheckViewSvg.values = {_op: _op
...
Elm.InnoCheckView.make = function (_elm) {
   ...
   var portMessageComp = function (model) {
      var msgComp = function (msg) {
         return A2($Html.div,
         _U.list([$Html$Attributes.$class("portmessage")]),
         _U.list([A2($Html.p,_U.list([]),_U.list([$Html.text(msg)]))]));
      };
   ...
   var aspectTipComp = function (model) {
      var aspect = $Basics.fst(A2($Maybe.withDefault,
      {ctor: "_Tuple2",_0: $InnoCheckModel.Leadership,_1: 0},
      $InnoCheckUtil.aspectForTip(model)));
      var msg = A2($Maybe.withDefault,
      "",
      A2($Dict.get,
   ...
   var showContactForm = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              ...
              _U.list([A2($Html.label,
                      _U.list([$Html$Attributes.$for("companyname")]),
                      _U.list([$Html.text("Naam bedrijf")]))
                      ,A2($Html.div,
                      _U.list([]),
              ...
              _U.list([A2($Html.label,
                      _U.list([$Html$Attributes.$for("firstname")]),
                      _U.list([$Html.text("Jouw naam")]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2($Html.input,
                      ...
                      _U.list([]))]))
                      ,A2($Html.label,
                      _U.list([$Html$Attributes.$for("lastname")
                              ,$Html$Attributes.$class("sr-only")]),
                      _U.list([$Html.text("Achternaam")]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2($Html.input,
              ...
              _U.list([$Html$Attributes.$class("group-input")]),
              _U.list([A2($Html.label,
                      _U.list([$Html$Attributes.$for("emailaddress")]),
                      _U.list([$Html.text("E-mailadres")]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2($Html.input,
   ...
   var showRecommendations = F2(function (address,model) {
      ...
      model.questions,
      model.questionAnswers) ? _U.list([A2($Html.section,
                                       _U.list([$Html$Attributes.$class("recommendations")]),
                                       _U.list([recommendationsTopParagraph,aspectTipComp(model)]))
                                       ,A2($Html.section,
                                       ...
                                       _U.list([moreInfoTopParagraph
                                               ,A2(showContactForm,address,model)]))]))]))]) : _U.list([]);
   });
   ...
   answerTextlist) {
      var liList = function (q) {
         ...
         _U.list([A2($Html.p,_U.list([]),_U.list([$Html.text(q.text)]))
                 ...
                 A4(showInputRadios,
                 address,
                 A2($Dict.get,q.key,model.questionAnswers),
                 q.key,
                 answerTextlist))]))]));
      };
   ...
   var showAspectButtons = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("aspect-questions-buttons")]),
      _U.list([A2($Html.button,
              _U.list([$Html$Attributes.type$("button")
                      ,$Html$Attributes.$class("btn btn-primary")
   ...
   var showQuestionBlock = F2(function (address,model) {
      ...
      _U.list([questionBlockTopParagraph
              ...
              ,A2($Html.div,
              _U.list([]),
              A2(showRecommendations,address,model))]));
   });
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2(showSplashScreen,address,model)]));
   });
