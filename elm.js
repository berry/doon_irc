...
Elm.SelectionList.make = function (_elm) {
   ...
   if (_elm.SelectionList.values) return _elm.SelectionList.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var selectedIndex = function (list) {    return $List.length(list.previous);};
   var previous = function (list) {
      var _p0 = list.previous;
      if (_p0.ctor === "[]") {
            return list;
         } else {
            return _U.update(list,{selected: _p0._0,previous: _p0._1,next: A2($List._op["::"],list.selected,list.next)});
         }
   };
   var next = function (list) {
      ...
      if (_p1.ctor === "[]") {
            ...
            return _U.update(list,{selected: _p1._0,previous: A2($List._op["::"],list.selected,list.previous),next: _p1._1});
         }
   };
   var $goto = F2(function (n,list) {
      $goto: while (true) {
         var curIndex = selectedIndex(list);
         if (_U.eq(curIndex,n)) return list; else if (_U.cmp(curIndex,n) < 0 && _U.cmp($List.length(list.next),0) > 0) {
                  var _v2 = n,_v3 = next(list);
                  n = _v2;
                  list = _v3;
                  continue $goto;
               } else if (_U.cmp(curIndex,A2($Basics.max,0,n)) > 0) {
                     var _v4 = n,_v5 = previous(list);
                     n = _v4;
                     list = _v5;
                     continue $goto;
                  } else return list;
   ...
   var selectedMap = F2(function (f,list) {
      return _U.update(list,{previous: A2($List.map,f(false),list.previous),selected: A2(f,true,list.selected),next: A2($List.map,f(false),list.next)});
   });
   var indexedMap = F2(function (f,list) {
      var nextLength = $List.length(list.next);
      var previousLength = $List.length(list.previous);
      return _U.update(list,
      {previous: $List.reverse(A2($List.indexedMap,f,$List.reverse(list.previous)))
      ,selected: A2(f,previousLength,list.selected)
      ,next: A2($List.indexedMap,function (index) {    return f(index + previousLength + 1);},list.next)});
   });
   var map2 = F3(function (f,listA,listB) {
      return _U.update(listA,
      {previous: A3($List.map2,f,listA.previous,listB.previous),selected: A2(f,listA.selected,listB.selected),next: A3($List.map2,f,listA.next,listB.next)});
   });
   var andMap = map2(F2(function (x,y) {    return x(y);}));
   var updateN = F3(function (n,f,list) {    return A2(indexedMap,F2(function (index,value) {    return _U.eq(index,n) ? f(value) : value;}),list);});
   var updateSelected = F2(function (f,list) {    return _U.update(list,{selected: f(list.selected)});});
   var map = F2(function (f,list) {
      return _U.update(list,{previous: A2($List.map,f,list.previous),selected: f(list.selected),next: A2($List.map,f,list.next)});
   });
   var length = function (list) {    return $List.length(list.previous) + 1 + $List.length(list.next);};
   var toList = function (list) {    return A2($Basics._op["++"],$List.reverse(list.previous),A2($Basics._op["++"],_U.list([list.selected]),list.next));};
   var SelectionList = F3(function (a,b,c) {    return {previous: a,selected: b,next: c};});
   var fromList = F2(function (selected,next) {    return A3(SelectionList,_U.list([]),selected,next);});
   return _elm.SelectionList.values = {_op: _op
...
Elm.InnoCheckModel = Elm.InnoCheckModel || {};
Elm.InnoCheckModel.make = function (_elm) {
   "use strict";
   _elm.InnoCheckModel = _elm.InnoCheckModel || {};
   if (_elm.InnoCheckModel.values) return _elm.InnoCheckModel.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var answerColorList = $Dict.fromList(_U.list([{ctor: "_Tuple2",_0: "Yes",_1: answerColorGreen}
                                                ,{ctor: "_Tuple2",_0: "Partly",_1: answerColorOrange}
                                                ,{ctor: "_Tuple2",_0: "No",_1: answerColorRed}]));
   var questionAnswersEmpty = $Dict.empty;
   var person0 = {email: "",phonenumber: "",firstname: "",lastname: "",companyname: ""};
   var Person = F5(function (a,b,c,d,e) {    return {email: a,phonenumber: b,firstname: c,lastname: d,companyname: e};});
   var Recommendation = F4(function (a,b,c,d) {    return {aspect: a,scoreMin: b,scoreMax: c,text: d};});
   var Question = F3(function (a,b,c) {    return {key: a,aspect: b,text: c};});
   var No = {ctor: "No"};
   var Partly = {ctor: "Partly"};
   var Yes = {ctor: "Yes"};
   var questionAnswers0 = $Dict.fromList(_U.list([{ctor: "_Tuple2",_0: 1,_1: Yes}
                                                 ,{ctor: "_Tuple2",_0: 2,_1: Yes}
                                                 ,{ctor: "_Tuple2",_0: 3,_1: No}
                                                 ,{ctor: "_Tuple2",_0: 4,_1: Partly}
                                                 ,{ctor: "_Tuple2",_0: 5,_1: No}
                                                 ,{ctor: "_Tuple2",_0: 6,_1: Yes}
                                                 ,{ctor: "_Tuple2",_0: 7,_1: Yes}
                                                 ,{ctor: "_Tuple2",_0: 8,_1: No}
                                                 ,{ctor: "_Tuple2",_0: 9,_1: Partly}
                                                 ,{ctor: "_Tuple2",_0: 10,_1: Yes}
                                                 ,{ctor: "_Tuple2",_0: 11,_1: Partly}
                                                 ,{ctor: "_Tuple2",_0: 12,_1: Yes}]));
   var answerTextList = _U.list([{ctor: "_Tuple2",_0: Yes,_1: "Ja"},{ctor: "_Tuple2",_0: Partly,_1: "Deels"},{ctor: "_Tuple2",_0: No,_1: "Nee"}]);
   var answerScoreList = _U.list([{ctor: "_Tuple2",_0: Yes,_1: 3},{ctor: "_Tuple2",_0: Partly,_1: 1},{ctor: "_Tuple2",_0: No,_1: 0}]);
   var Improve = {ctor: "Improve"};
   var MeasureAndMonitor = {ctor: "MeasureAndMonitor"};
   var Processes = {ctor: "Processes"};
   var Resources = {ctor: "Resources"};
   ...
   var questions = _U.list([{key: 1
                           ...
                           ,{key: 11,aspect: Improve,text: "Wordt het innovatieproces zelf stelselmatig geanalyseerd en beoordeeld op de goede werking?"}
                           ,{key: 12
                            ,aspect: Improve
   ...
   var recommendations = _U.list([{aspect: Leadership
                                  ,scoreMin: 0.0
                                  ,scoreMax: 0.3
                                  ,text: "Leg 1 of 2 concrete innovatiedoelen vast in het bedrijfsplan voor dit jaar."}
                                 ,{aspect: Leadership,scoreMin: 0.3,scoreMax: 1.0,text: "Goed bezig. Focus eerst op het verbeteren van de andere aspecten."}]);
   var aspectList = _U.list([{ctor: "_Tuple2",_0: Leadership,_1: "Leiderschap"}
                            ,{ctor: "_Tuple2",_0: Culture,_1: "Cultuur"}
                            ,{ctor: "_Tuple2",_0: Processes,_1: "Processen"}
                            ,{ctor: "_Tuple2",_0: Resources,_1: "Middelen"}
                            ,{ctor: "_Tuple2",_0: MeasureAndMonitor,_1: "Meten en monitoren"}
                            ,{ctor: "_Tuple2",_0: Improve,_1: "Verbeteren"}]);
   var aspectTips = $Dict.fromList(_U.list([{ctor: "_Tuple2"
   ...
   var aspectSelectionList0 = A2($SelectionList.fromList,Leadership,_U.list([Culture,Processes,Resources,MeasureAndMonitor,Improve]));
   var initialModel0 = {questions: questions
   ...
   return _elm.InnoCheckModel.values = {_op: _op
                                       ...
                                       ,Resources: Resources
                                       ,Processes: Processes
                                       ,MeasureAndMonitor: MeasureAndMonitor
                                       ,Improve: Improve
                                       ,Yes: Yes
                                       ,Partly: Partly
                                       ,No: No
...
Elm.InnoCheckUtil.make = function (_elm) {
   "use strict";
   _elm.InnoCheckUtil = _elm.InnoCheckUtil || {};
   if (_elm.InnoCheckUtil.values) return _elm.InnoCheckUtil.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var getValue = F2(function (dict,key) {    return A2($Dict.get,$Basics.toString(key),dict);});
   var unionToDict = function (list) {
      return $Dict.fromList(A2($List.map,function (_p0) {    var _p1 = _p0;return {ctor: "_Tuple2",_0: $Basics.toString(_p1._0),_1: _p1._1};},list));
   };
   var getAspectText = function (aspect) {    return A2($Maybe.withDefault,"",A2(getValue,unionToDict($InnoCheckModel.aspectList),aspect));};
   var getAnswerText = function (answer) {    return A2($Maybe.withDefault,"",A2(getValue,unionToDict($InnoCheckModel.answerTextList),answer));};
   var numberOfQuestionsAnswered = F2(function (questions,qanswers) {
      var qkeys = A2($List.map,function (q) {    return q.key;},questions);
      var filter = function (key) {    return A2($Dict.member,key,qanswers) ? $Maybe.Just(key) : $Maybe.Nothing;};
      return $List.length(A2($List.filterMap,filter,qkeys));
   });
   var allQuestionsAnswered = F2(function (questions,qanswers) {    return _U.eq(A2(numberOfQuestionsAnswered,questions,qanswers),$List.length(questions));});
   var meanScoreColor = F2(function (aqa,score) {
      return _U.cmp(score,0) > -1 && _U.cmp(score,30) < 1 && aqa ? $InnoCheckModel.answerColorRed : _U.cmp(score,30) > 0 && _U.cmp(score,
      60) < 0 && aqa ? $InnoCheckModel.answerColorOrange : _U.cmp(score,60) > -1 && _U.cmp(score,
      100) < 1 && aqa ? $InnoCheckModel.answerColorGreen : $InnoCheckModel.answerColorEmpty;
   });
   var sumOfScores = function (kscores) {    return $List.sum($Dict.values(unionToDict(kscores)));};
   var meanScore = function (kscores) {
      var topScore = A2($Maybe.withDefault,0,A2($Dict.get,$Basics.toString($InnoCheckModel.Yes),unionToDict($InnoCheckModel.answerScoreList)));
   ...
   var listQuestionAspectAnswerScore = F2(function (questions,kscores) {
      var getAnswerScore = function (q) {    return {ctor: "_Tuple2",_0: q.aspect,_1: A2($Maybe.withDefault,0,A2($Dict.get,q.key,kscores))};};
      return A2($List.map,getAnswerScore,questions);
   });
   var listQuestionKeyAnswerScore = F2(function (questions,kscores) {
      var getAnswerScore = function (q) {    return {ctor: "_Tuple2",_0: q.key,_1: A2($Maybe.withDefault,0,A2($Dict.get,q.key,kscores))};};
      return A2($List.map,getAnswerScore,questions);
   });
   var listAnswerScore = function (qas) {
      var getAnswerScore = F2(function (key,answer) {
         return A2($Maybe.withDefault,0,A2($Dict.get,$Basics.toString(answer),unionToDict($InnoCheckModel.answerScoreList)));
      });
      return A2($Dict.map,getAnswerScore,qas);
   };
   var listQuestionKeyAnswerColor = F2(function (questions,acolors) {
      var getAnswerColor = function (q) {
         return {ctor: "_Tuple2",_0: q.key,_1: A2($Maybe.withDefault,$InnoCheckModel.answerColorEmpty,A2($Dict.get,q.key,acolors))};
      };
      return A2($List.map,getAnswerColor,questions);
   });
   var listAnswerColor = function (qas) {
      var getAnswerColor = F2(function (key,answer) {
         return A2($Maybe.withDefault,$InnoCheckModel.answerColorEmpty,A2($Dict.get,$Basics.toString(answer),$InnoCheckModel.answerColorList));
      });
      return A2($Dict.map,getAnswerColor,qas);
   };
   var aspectQuestions = F2(function (questions,aspect) {    return A2($List.filter,function (q) {    return _U.eq(q.aspect,aspect);},questions);});
   var meanScorePerAspect = function (model) {
      ...
      var answerScores = function (aspect) {
         return A2(listQuestionKeyAnswerScore,A2(aspectQuestions,model.questions,aspect),listAnswerScore(model.questionAnswers));
      };
      var meanOfAnswers = function (aspect) {    return meanScore(answerScores(aspect));};
      return A2($List.map,function (aspect) {    return {ctor: "_Tuple2",_0: aspect,_1: meanOfAnswers(aspect)};},aspectList);
   };
   var aspectForTip = function (model) {
      var aspectScores = meanScorePerAspect(model);
      var scoreOrange = A2($List.filter,function (_p2) {    var _p3 = _p2;var _p4 = _p3._1;return _U.cmp(_p4,30) > 0 && _U.cmp(_p4,60) < 0;},aspectScores);
      var scoreRed = A2($List.filter,function (_p5) {    var _p6 = _p5;var _p7 = _p6._1;return _U.cmp(_p7,0) > -1 && _U.cmp(_p7,30) < 1;},aspectScores);
      return _U.cmp($List.length(scoreRed),0) > 0 ? $List.head(scoreRed) : _U.cmp($List.length(scoreOrange),0) > 0 ? $List.head(scoreOrange) : $Maybe.Nothing;
   };
   return _elm.InnoCheckUtil.values = {_op: _op
...
Elm.InnoCheckBackend.make = function (_elm) {
   "use strict";
   _elm.InnoCheckBackend = _elm.InnoCheckBackend || {};
   if (_elm.InnoCheckBackend.values) return _elm.InnoCheckBackend.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var encodePerson = function (person) {
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "email",_1: $Json$Encode.string(person.email)}
                                         ,{ctor: "_Tuple2",_0: "phonenumber",_1: $Json$Encode.string(person.phonenumber)}
                                         ,{ctor: "_Tuple2",_0: "firstname",_1: $Json$Encode.string(person.firstname)}
                                         ,{ctor: "_Tuple2",_0: "lastname",_1: $Json$Encode.string(person.lastname)}
                                         ,{ctor: "_Tuple2",_0: "companyname",_1: $Json$Encode.string(person.companyname)}]));
   };
   var encodeQuestionAnwsers = function (questionAnswers) {
      var encodeQuestionAnswer = function (_p0) {
         var _p1 = _p0;
         return {ctor: "_Tuple2",_0: $Basics.toString(_p1._0),_1: $Json$Encode.string($InnoCheckUtil.getAnswerText(_p1._1))};
      };
      return $Json$Encode.object(A2($List.map,encodeQuestionAnswer,$Dict.toList(questionAnswers)));
   };
   var encodeQuestions = function (questions) {
      var encodeQuestion = function (q) {
         return $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "key",_1: $Json$Encode.$int(q.key)}
                                            ,{ctor: "_Tuple2",_0: "aspect",_1: $Json$Encode.string($InnoCheckUtil.getAspectText(q.aspect))}
                                            ,{ctor: "_Tuple2",_0: "text",_1: $Json$Encode.string(q.text)}]));
      };
      return $Json$Encode.list(A2($List.map,encodeQuestion,questions));
   };
   var ircObject = function (model) {
      return $Json$Encode.object(_U.list([{ctor: "_Tuple2",_0: "person",_1: encodePerson(model.person)}
                                         ,{ctor: "_Tuple2",_0: "questions",_1: encodeQuestions(model.questions)}
                                         ,{ctor: "_Tuple2",_0: "questionAnswers",_1: encodeQuestionAnwsers(model.questionAnswers)}
                                         ,{ctor: "_Tuple2",_0: "actionTime",_1: $Json$Encode.string(model.actionTime)}]));
   };
...
Elm.InnoCheckUpdate.make = function (_elm) {
   ...
   if (_elm.InnoCheckUpdate.values) return _elm.InnoCheckUpdate.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Date = Elm.Date.make(_elm),
   ...
   $Time = Elm.Time.make(_elm);
   var _op = {};
   var HandleTimedStoreIrcData = function (a) {    return {ctor: "HandleTimedStoreIrcData",_0: a};};
   var timedStoreIrcData = $Effects.task(A2($Task.map,HandleTimedStoreIrcData,$Task.toMaybe($TaskTutorial.getCurrentTime)));
   var HandleBackendResponse = function (a) {    return {ctor: "HandleBackendResponse",_0: a};};
   var storeIrcData = function (model) {
      return $Effects.task(A2($Task.map,
      HandleBackendResponse,
      $Task.toResult(A2($ElmFire.set,$InnoCheckBackend.ircObject(model),$ElmFire.push($ElmFire.fromUrl($InnoCheckModel.postUrl))))));
   };
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "Noop": return {ctor: "_Tuple2",_0: model,_1: $Effects.none};
         case "SplashRead": return {ctor: "_Tuple2",_0: _U.update(model,{splashScreenRead: true}),_1: $Effects.none};
         case "SelectAspect": return {ctor: "_Tuple2"
                                     ...
                                     {aspectSelectionList: function () {
                                        ...
                                        F2(function (i,a) {    return {ctor: "_Tuple2",_0: $Basics.toString(a),_1: i};}),
                                        model.aspectSelectionList)))));
                                        return A2($SelectionList.$goto,index,model.aspectSelectionList);
                                     }()})
                                     ,_1: $Effects.none};
         case "NextAspect": return {ctor: "_Tuple2"
                                   ,_0: _U.update(model,{aspectSelectionList: $SelectionList.next(model.aspectSelectionList)})
                                   ,_1: $Effects.none};
         case "PrevAspect": return {ctor: "_Tuple2"
                                   ,_0: _U.update(model,{aspectSelectionList: $SelectionList.previous(model.aspectSelectionList)})
                                   ,_1: $Effects.none};
         case "SelectAnswer": return {ctor: "_Tuple2"
                                     ,_0: _U.update(model,{questionAnswers: A3($Dict.insert,_p0._0,_p0._1,model.questionAnswers),isDirty: true})
                                     ,_1: $Effects.none};
         case "HandleBackendResponse": var _p1 = _p0._0;
           if (_p1.ctor === "Ok") {
                 return {ctor: "_Tuple2",_0: _U.update(model,{sendAttempted: true,sendSuccess: true,isDirty: false}),_1: $Effects.none};
              } else {
                 return {ctor: "_Tuple2"
                        ,_0: _U.update(model,{sendAttempted: true,sendSuccess: false,sendErrorMessage: $Basics.toString(_p1._0)})
                        ,_1: $Effects.none};
              }
         case "EditEmailAddress": var prs = model.person;
           return {ctor: "_Tuple2",_0: _U.update(model,{person: _U.update(prs,{email: _p0._0}),isDirty: true}),_1: $Effects.none};
         case "EditFirstName": var prs = model.person;
           return {ctor: "_Tuple2",_0: _U.update(model,{person: _U.update(prs,{firstname: _p0._0}),isDirty: true}),_1: $Effects.none};
         case "EditLastName": var prs = model.person;
           return {ctor: "_Tuple2",_0: _U.update(model,{person: _U.update(prs,{lastname: _p0._0}),isDirty: true}),_1: $Effects.none};
         case "EditCompanyName": var prs = model.person;
           return {ctor: "_Tuple2",_0: _U.update(model,{person: _U.update(prs,{companyname: _p0._0}),isDirty: true}),_1: $Effects.none};
         case "EditPhoneNumber": var prs = model.person;
           return {ctor: "_Tuple2",_0: _U.update(model,{person: _U.update(prs,{phonenumber: _p0._0}),isDirty: true}),_1: $Effects.none};
         case "SendButtonClicked": return {ctor: "_Tuple2"
                                          ,_0: _U.update(model,{sendErrorMessage: "",sendSuccess: false,sendAttempted: false})
                                          ,_1: timedStoreIrcData};
         default: var newModel = _U.update(model,{actionTime: A2($Date$Format.format,"%d-%m-%Y %H:%M:%S",$Date.fromTime(A2($Maybe.withDefault,0,_p0._0)))});
           return {ctor: "_Tuple2",_0: newModel,_1: storeIrcData(newModel)};}
   });
   var SendButtonClicked = {ctor: "SendButtonClicked"};
   var EditPhoneNumber = function (a) {    return {ctor: "EditPhoneNumber",_0: a};};
   var EditCompanyName = function (a) {    return {ctor: "EditCompanyName",_0: a};};
   var EditLastName = function (a) {    return {ctor: "EditLastName",_0: a};};
   var EditFirstName = function (a) {    return {ctor: "EditFirstName",_0: a};};
   var EditEmailAddress = function (a) {    return {ctor: "EditEmailAddress",_0: a};};
   var SelectAnswer = F2(function (a,b) {    return {ctor: "SelectAnswer",_0: a,_1: b};});
   var PrevAspect = {ctor: "PrevAspect"};
   var NextAspect = {ctor: "NextAspect"};
   var SelectAspect = function (a) {    return {ctor: "SelectAspect",_0: a};};
...
Elm.InnoCheckViewUtil.make = function (_elm) {
   "use strict";
   _elm.InnoCheckViewUtil = _elm.InnoCheckViewUtil || {};
   if (_elm.InnoCheckViewUtil.values) return _elm.InnoCheckViewUtil.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var clickable = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "cursor",_1: "pointer"}]));
   return _elm.InnoCheckViewUtil.values = {_op: _op,clickable: clickable};
};
Elm.InnoCheckViewSvg = Elm.InnoCheckViewSvg || {};
Elm.InnoCheckViewSvg.make = function (_elm) {
   "use strict";
   _elm.InnoCheckViewSvg = _elm.InnoCheckViewSvg || {};
   if (_elm.InnoCheckViewSvg.values) return _elm.InnoCheckViewSvg.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var _op = {};
   var showIcon = F2(function (aspect,_p0) {
      var _p1 = _p0;
      return A2($Svg.image,
      _U.list([$Svg$Attributes.x($Basics.toString(_p1._0))
   ...
   var showColorBlock = F5(function (address,model,aspect,_p3,_p2) {
      var _p4 = _p3;
      var _p5 = _p2;
      var aqa = A2($InnoCheckUtil.allQuestionsAnswered,A2($InnoCheckUtil.aspectQuestions,model.questions,aspect),model.questionAnswers);
      var answerScores = A2($InnoCheckUtil.listQuestionKeyAnswerScore,
      A2($InnoCheckUtil.aspectQuestions,model.questions,aspect),
      $InnoCheckUtil.listAnswerScore(model.questionAnswers));
      var meanOfAnswers = $InnoCheckUtil.meanScore(answerScores);
      var aspectScoreColor = A2($InnoCheckUtil.meanScoreColor,aqa,meanOfAnswers);
      return A2($Svg.svg,
      _U.list([$InnoCheckViewUtil.clickable,A2($Html$Events.onClick,address,$InnoCheckUpdate.SelectAspect(aspect))]),
      _U.list([A2($Svg.rect,
              _U.list([$Svg$Attributes.fill(aspectScoreColor)
                      ,$Svg$Attributes.x($Basics.toString(_p4._0))
                      ,$Svg$Attributes.y($Basics.toString(_p4._1))
                      ,$Svg$Attributes.width($Basics.toString(_p4._2))
                      ,$Svg$Attributes.height($Basics.toString(_p4._3))]),
              _U.list([]))
              ,A2(showIcon,aspect,{ctor: "_Tuple2",_0: _p5._0,_1: _p5._1})]));
   });
   var showCanvas = F2(function (address,model) {
      var canvasScalingFactor = 1;
      var cWidth = $Basics.toString(canvasScalingFactor * 400);
      var cHeight = $Basics.toString(canvasScalingFactor * 282);
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.version("1.1")
              ,$Svg$Attributes.x("0")
              ,$Svg$Attributes.y("0")
              ,$Svg$Attributes.width(cWidth)
              ,$Svg$Attributes.height(cHeight)
              ,$Svg$Attributes.viewBox("0 0 400 282")]),
      _U.list([A2($Svg.rect,
              _U.list([$Svg$Attributes.fill("#DDDDDD")
                      ,$Svg$Attributes.x("0")
                      ,$Svg$Attributes.y("0")
                      ,$Svg$Attributes.width("400")
                      ,$Svg$Attributes.height("282")]),
              _U.list([]))
              ,A5(showColorBlock,address,model,$InnoCheckModel.Leadership,{ctor: "_Tuple4",_0: 10,_1: 10,_2: 90,_3: 126},{ctor: "_Tuple2",_0: 15,_1: 30})
              ,A5(showColorBlock,address,model,$InnoCheckModel.Processes,{ctor: "_Tuple4",_0: 110,_1: 10,_2: 180,_3: 126},{ctor: "_Tuple2",_0: 160,_1: 30})
              ,A5(showColorBlock,
              address,
              model,
              ...
              ,A5(showColorBlock,address,model,$InnoCheckModel.Culture,{ctor: "_Tuple4",_0: 10,_1: 146,_2: 90,_3: 126},{ctor: "_Tuple2",_0: 15,_1: 166})
              ,A5(showColorBlock,address,model,$InnoCheckModel.Resources,{ctor: "_Tuple4",_0: 110,_1: 146,_2: 180,_3: 126},{ctor: "_Tuple2",_0: 160,_1: 166})
              ,A5(showColorBlock,address,model,$InnoCheckModel.Improve,{ctor: "_Tuple4",_0: 300,_1: 146,_2: 90,_3: 126},{ctor: "_Tuple2",_0: 305,_1: 166})]));
   });
   return _elm.InnoCheckViewSvg.values = {_op: _op,showCanvas: showCanvas,showColorBlock: showColorBlock,showIcon: showIcon};
};
Elm.InnoCheckView = Elm.InnoCheckView || {};
Elm.InnoCheckView.make = function (_elm) {
   "use strict";
   _elm.InnoCheckView = _elm.InnoCheckView || {};
   if (_elm.InnoCheckView.values) return _elm.InnoCheckView.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var aspectTipComp = function (model) {
      var aspect = $Basics.fst(A2($Maybe.withDefault,{ctor: "_Tuple2",_0: $InnoCheckModel.Leadership,_1: 0},$InnoCheckUtil.aspectForTip(model)));
      var msg = A2($Maybe.withDefault,"",A2($Dict.get,$Basics.toString(aspect),$InnoCheckModel.aspectTips));
      return A2($Html.div,_U.list([$Html$Attributes.$class("well")]),_U.list([$Markdown.toHtml(msg)]));
   };
   var showContactForm = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.form,
      _U.list([]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("group-input")]),
              _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("companyname")]),_U.list([$Html.text("Naam bedrijf")]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2($Html.input,
                      _U.list([$Html$Attributes.value(model.person.companyname)
                              ,$Html$Attributes.type$("text")
                              ,A3($Html$Events.on,
                              "input",
                              $Html$Events.targetValue,
                              function (_p0) {
                                 return A2($Signal.message,address,$InnoCheckUpdate.EditCompanyName(_p0));
                              })
              ...
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("group-input")]),
              _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("firstname")]),_U.list([$Html.text("Voornaam")]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2($Html.input,
                      _U.list([$Html$Attributes.value(model.person.firstname)
                              ,$Html$Attributes.type$("text")
                              ,A3($Html$Events.on,
                              "input",
                              $Html$Events.targetValue,
                              function (_p1) {
                                 return A2($Signal.message,address,$InnoCheckUpdate.EditFirstName(_p1));
                              })
              ...
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("group-input")]),
              _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("lastname")]),_U.list([$Html.text("Achternaam")]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2($Html.input,
                      _U.list([$Html$Attributes.value(model.person.lastname)
                              ,$Html$Attributes.type$("text")
                              ,A3($Html$Events.on,
                              "input",
                              $Html$Events.targetValue,
                              function (_p2) {
                                 return A2($Signal.message,address,$InnoCheckUpdate.EditLastName(_p2));
                              })
              ...
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("group-input")]),
              _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("emailaddress")]),_U.list([$Html.text("E-mailadres")]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2($Html.input,
                      _U.list([$Html$Attributes.value(model.person.email)
                              ,$Html$Attributes.type$("email")
                              ,A3($Html$Events.on,
                              "input",
                              $Html$Events.targetValue,
                              function (_p3) {
                                 return A2($Signal.message,address,$InnoCheckUpdate.EditEmailAddress(_p3));
                              })
              ...
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("group-input")]),
              _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("phonenumber")]),_U.list([$Html.text("Telefoonnummer")]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2($Html.input,
                      _U.list([$Html$Attributes.value(model.person.phonenumber)
                              ,$Html$Attributes.type$("text")
                              ,A3($Html$Events.on,
                              "input",
                              $Html$Events.targetValue,
                              function (_p4) {
                                 return A2($Signal.message,address,$InnoCheckUpdate.EditPhoneNumber(_p4));
                              })
                              ,$Html$Attributes.placeholder("Telefoonnummer")
                              ,$Html$Attributes.id("phonenumber")]),
                      _U.list([]))]))]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("group-button")]),
              _U.list([A2($Html.label,_U.list([]),_U.list([]))
                      ,A2($Html.div,
                      _U.list([]),
                      _U.list([A2($Html.button,
                      _U.list([$Html$Attributes.type$("button")
   ...
   var showRecommendations = F2(function (address,model) {
      return A2($InnoCheckUtil.allQuestionsAnswered,model.questions,model.questionAnswers) ? _U.list([A2($Html.section,
                                                                                                     ...
                                                                                                     _U.list([recommendationsTopParagraph
                                                                                                             ,aspectTipComp(model)]))
                                                                                                     ,A2($Html.section,
                                                                                                     _U.list([$Html$Attributes.$class("contact")]),
                                                                                                     _U.list([A2($Html.div,
                                                                                                     _U.list([$Html$Attributes.$class("row")]),
                                                                                                     _U.list([A2($Html.div,
                                                                                                     _U.list([$Html$Attributes.$class("col-sm-8")]),
                                                                                                     _U.list([moreInfoTopParagraph
                                                                                                             ,A2(showContactForm,
                                                                                                             address,
                                                                                                             model)]))]))]))]) : _U.list([]);
   });
   var showInputRadios = F4(function (address,storedAnswer,key,answerTextlist) {
      var checkAnswer = F2(function (answer,storedAnswer) {
         var _p5 = storedAnswer;
         if (_p5.ctor === "Nothing") {
               return false;
            } else {
               return _U.eq(answer,_p5._0);
            }
      });
      var radios = function (_p6) {
         var _p7 = _p6;
         var _p10 = _p7._1;
         var _p9 = _p7._0;
         ...
         _U.list([A2($Html.input,
                 _U.list([$Html$Attributes.type$("checkbox")
                         ,$Html$Attributes.name(A2($Basics._op["++"],"qa_",$Basics.toString(key)))
                         ,$Html$Attributes.value(_p10)
                         ,A3($Html$Events.on,
                         "change",
                         $Html$Events.targetChecked,
                         function (_p8) {
                            return A2($Signal.message,address,A2($InnoCheckUpdate.SelectAnswer,key,_p9));
                         })
                         ,$Html$Attributes.checked(A2(checkAnswer,_p9,storedAnswer))]),
                 _U.list([]))
                 ,$Html.text(_p10)]));
      };
      return A2($List.map,radios,answerTextlist);
   });
   var showQuestions = F4(function (address,model,questions,answerTextlist) {
      var liList = function (q) {
         return A2($Html.li,
         _U.list([]),
         _U.list([A2($Html.p,_U.list([]),_U.list([$Html.text(q.text)]))
                 ,A2($Html.form,
                 _U.list([$Html$Attributes.$class("inputradios")]),
                 _U.list([A2($Html.div,_U.list([]),A4(showInputRadios,address,A2($Dict.get,q.key,model.questionAnswers),q.key,answerTextlist))]))]));
      };
      return A2($List.map,liList,questions);
   });
   var showAspectButtons = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("aspect-questions-buttons button-block sqs-block-button")]),
      _U.list([A2($Html.button,
              _U.list([$Html$Attributes.type$("button")
                      ,$Html$Attributes.$class("btn btn-primary sqs-block-button-element--small sqs-block-button-element")
                      ,$Html$Attributes.disabled(_U.eq($List.length(model.aspectSelectionList.previous),0))
                      ,A2($Html$Events.onClick,address,$InnoCheckUpdate.PrevAspect)]),
              _U.list([$Html.text("« Vorige aspect")]))
              ,$Html.text(" ")
              ,A2($Html.button,
              _U.list([$Html$Attributes.type$("button")
                      ,$Html$Attributes.$class("btn btn-primary sqs-block-button-element--small sqs-block-button-element")
                      ,$Html$Attributes.disabled(_U.eq($List.length(model.aspectSelectionList.next),0) || $Basics.not(A2($InnoCheckUtil.allQuestionsAnswered,
                      A2($InnoCheckUtil.aspectQuestions,model.questions,model.aspectSelectionList.selected),
                      model.questionAnswers)))
                      ,A2($Html$Events.onClick,address,$InnoCheckUpdate.NextAspect)]),
              _U.list([$Html.text("Volgende aspect »")]))]));
   });
   ...
   var showSplashScreen = F2(function (address,model) {
      ...
      _U.list([A2($Html.section,
              ...
              _U.list([splashParagraph,A3(buttonComp,address,$InnoCheckUpdate.SplashRead,"Start de Quickscan »")]))
              ,A2($Html.div,
   ...
   var view = F2(function (address,model) {
      return A2($Html.div,_U.list([$Html$Attributes.$class("container")]),_U.list([A2(showSplashScreen,address,model)]));
   });
   return _elm.InnoCheckView.values = {_op: _op
                                      ,view: view
...
Elm.InnoCheck.make = function (_elm) {
   "use strict";
   _elm.InnoCheck = _elm.InnoCheck || {};
   if (_elm.InnoCheck.values) return _elm.InnoCheck.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var app = $StartApp.start({init: {ctor: "_Tuple2",_0: $InnoCheckModel.initialModel0,_1: $Effects.none}
